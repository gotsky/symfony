...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oc_platform.advert_purger' => 'getOcPlatform_AdvertPurgerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'kornemuse', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_221344fac6e4e936a9ff558d50fcfd68fc39dc5f71373f610ef3e186d8ff04a4');
    ...
    /**
     * Gets the 'oc_platform.advert_purger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Purger\AdvertPurger A OC\PlatformBundle\Purger\AdvertPurger instance.
     */
    protected function getOcPlatform_AdvertPurgerService()
    {
        return $this->services['oc_platform.advert_purger'] = new \OC\PlatformBundle\Purger\AdvertPurger($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('name' => 'sf2session', 'gc_probability' => 1), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fk8g5gvd8z)ogk7jh4k67kh,7j8,7ngf');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'kornemuse',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'fr',
            'secret' => 'fk8g5gvd8z)ogk7jh4k67kh,7j8,7ngf',
            'debug_toolbar' => true,
            ...
            'kernel.secret' => 'fk8g5gvd8z)ogk7jh4k67kh,7j8,7ngf',
