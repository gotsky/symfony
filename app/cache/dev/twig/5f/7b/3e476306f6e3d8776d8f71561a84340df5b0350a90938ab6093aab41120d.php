...
class __TwigTemplate_5f7b3e476306f6e3d8776d8f71561a84340df5b0350a90938ab6093aab41120d extends Twig_Template
{
...
";
    ...
    public function getdisplay_message($__log_index__ = null, $__log__ = null)
    {
        ...
        try {
            // line 108
            echo "    ";
            if ((twig_constant("Symfony\\Component\\Debug\\ErrorHandler::TYPE_DEPRECATION") == (($this->getAttribute($this->getAttribute($this->getContext($context, "log", true), "context", array(), "any", false, true), "type", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getContext($context, "log", true), "context", array(), "any", false, true), "type", array()), 0)) : (0)))) {
                // line 109
                echo "        DEPRECATION -  ";
